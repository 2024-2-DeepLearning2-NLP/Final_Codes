...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    ...
    -seed 1 \
    -model t5-small \
    -log_file logs/tweetsumm_omission_t5_small_demo.log \
    -output_dir models/tweetsumm_omission_t5_small_demo \
    -dataset data/tweetsumm/tweetsumm \
    -prefix summarize: \
    -max_source_length 1024 \
    -max_target_length 120 \
    ...
    -val_min_target_length 1 \
    -num_beams 1 \
    -save_path data/tweetsumm_omission/t5_small_demo \
    -preprocessing_num_workers 1 \
    -result_dir results/tweetsumm_demo
