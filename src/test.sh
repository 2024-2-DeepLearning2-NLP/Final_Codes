...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    ...
    -checkpoint /home/gaya/group1/OLDS/models/qmsum_bert_base_pair/round_1 \
    -dataset /home/gaya/group1/OLDS/data/qmsum_omission/omission.save \
    -domain all \
    -log_file logs_detection_test/qmsum.bert_base.pair.test.log \
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_test True \
    -model bert-base-uncased \
    -checkpoint /home/gaya/group1/OLDS/models/qmsum_bert_base_seq/round_1 \
    -dataset /home/gaya/group1/OLDS/data/qmsum_omission/omission.save \
    -domain all \
    -log_file logs_detection_test/qmsum.bert_base.seq.test.log \
    -max_source_length 512 \
    -per_device_eval_batch_size 32 \
    -preprocessing_num_workers 8 \
    -mode seq
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_test True \
    -model bert-base-uncased \
    -checkpoint /home/gaya/group1/OLDS/models/qmsum_bert_base_span/round_5 \
    -dataset /home/gaya/group1/OLDS/data/qmsum_omission/omission.save \
    -domain bart_base \
    -log_file logs_detection_test/qmsum.bert_base.span.test.log \
    -max_source_length 512 \
    -per_device_eval_batch_size 64 \
    -preprocessing_num_workers 16 \
    -mode span
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_test True \
    -model roberta-base \
    -checkpoint models/qmsum_roberta_base_seq/round_3 \
    -dataset /home/gaya/group1/OLDS/data/qmsum_omission/omission.save \
    -domain all \
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_test True \
    -model roberta-base \
    -checkpoint models/qmsum_roberta_base_span/round_5 \
    -dataset /home/gaya/group1/OLDS/data/qmsum_omission/omission.save \
    -domain all \
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    ...
    -dataset /home/gaya/group1/OLDS/data/qmsum_omission/omission.save \
    -domain pegasus \
    -log_file logs_detection_test/qmsum.roberta_base.span.test.log \
    -max_source_length 512 \
    -per_device_eval_batch_size 64 \
    -preprocessing_num_workers 16 \
    -mode span
