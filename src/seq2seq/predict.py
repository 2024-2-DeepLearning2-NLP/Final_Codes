...
def predict(args, logger, accelerator, tokenizer=None, model=None, dataset=None):
    ...
    for batch in eval_dataloader:
        ...
        with torch.no_grad():
            ...
            **gen_kwargs  # This will already include return_dict_in_generate
            ) 
            
            # Extract sequences and scores
            generated_tokens = outputs['sequences']
            scores = outputs.get('sequences_scores', None)  # Use .get() to avoid KeyError

            # Pad and gather generated tokens
